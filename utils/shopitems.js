const shop_items = [
    {name: 'Cactus Card', cost: 250, id: 'cactus', shopimg: 'shopcactus'},
    {name: 'Weize Card', cost: 750, id: 'weize', shopimg: 'shopweize'},
    {name: 'Barze Card', cost: 1200, id: 'barze', shopimg: 'shopbarze'},
